      ...
      >
        ...
        <Script id="google-tag-manager" strategy="beforeInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-KC2J5JQC');
          `}
        </Script>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KC2J5JQC"
            height="0"
            width="0"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=2264362510984032&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
