        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 lg:mb-12">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-6 py-3 rounded-full text-sm font-medium text-white bg-aura-accent hover:bg-aura-accent-dark transition-all duration-300 w-fit"
            >
              <MdOutlineAddHome className="w-5 h-5" />
              {isAr ? "أضف إعلان جديد" : "Add New Listing"}
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-9 min-w-0">
              {listingsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-24 gap-6 bento-card bg-aura-card rounded-3xl border border-aura-border">
