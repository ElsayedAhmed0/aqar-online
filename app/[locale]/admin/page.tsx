...
const settingsFields = [
  { key: "site_name_ar",       label_ar: "اسم الموقع (عربي)",         label_en: "Site Name (Arabic)",         type: "text" },
  { key: "site_name_en",       label_ar: "اسم الموقع (إنجليزي)",      label_en: "Site Name (English)",        type: "text" },
  { key: "hero_title_ar",      label_ar: "عنوان الهيرو (عربي)",       label_en: "Hero Title (Arabic)",        type: "text" },
  { key: "hero_title_en",      label_ar: "عنوان الهيرو (إنجليزي)",    label_en: "Hero Title (English)",       type: "text" },
  { key: "hero_subtitle_ar",   label_ar: "وصف الهيرو (عربي)",         label_en: "Hero Subtitle (Arabic)",     type: "text" },
  { key: "hero_subtitle_en",   label_ar: "وصف الهيرو (إنجليزي)",      label_en: "Hero Subtitle (English)",    type: "text" },
  { key: "hero_image",         label_ar: "صورة الهيرو (URL)",         label_en: "Hero Image (URL)",           type: "text" },
  { key: "footer_phone",       label_ar: "رقم الهاتف",                label_en: "Phone Number",               type: "text" },
  { key: "footer_email",       label_ar: "البريد الإلكتروني",         label_en: "Email",                      type: "text" },
  { key: "footer_address_ar",  label_ar: "العنوان (عربي)",            label_en: "Address (Arabic)",           type: "text" },
  { key: "footer_address_en",  label_ar: "العنوان (إنجليزي)",         label_en: "Address (English)",          type: "text" },
  { key: "stats_properties",   label_ar: "عدد العقارات",              label_en: "Properties Count",           type: "text" },
  { key: "stats_clients",      label_ar: "عدد العملاء",               label_en: "Clients Count",              type: "text" },
  { key: "stats_years",        label_ar: "سنوات الخبرة",              label_en: "Years of Experience",        type: "text" },
];
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 ${
                  activeTab === tab.id ? "bg-aura-dark text-white" : "text-aura-muted hover:text-aura-dark"
                }`}
              >
                {tab.icon}
                {isAr ? tab.ar : tab.en}
