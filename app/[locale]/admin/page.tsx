                            ...
                            <div className="bento-card bg-aura-card rounded-3xl p-6 border border-aura-border">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        { key: "badge_ar", label_ar: "البادج (عربي) — مثال: مميز / جديد / عرض خاص", label_en: "Badge (Arabic)" },
                                        { key: "badge_en", label_ar: "البادج (إنجليزي)", label_en: "Badge (English)" },
                                        { key: "price", label_ar: "السعر — مثال: من 2 مليون جنيه", label_en: "Price" },
                                        { key: "image_url", label_ar: "رابط الصورة (URL)", label_en: "Image URL" },
                                                ...
                                                <div className="flex gap-2">
                                                    <button onClick={() => {
                                                        ...
                                                        setAdForm({
                                                            ...
                                                            subtitle_en: ad.subtitle_en || "",
                                                            badge_ar: (ad as any).badge_ar || "",
                                                            badge_en: (ad as any).badge_en || "",
                                                            price: (ad as any).price || "",
                                                            image_url: ad.image_url || "",
                                                            link: ad.link || "",
                                                            order_num: String(ad.order_num),
                                                        });
                                                    }}
