      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div key={activeFilter} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((property) => (
            <div
              key={property.id}
              className="bento-card card-animate bg-aura-card rounded-3xl overflow-hidden group cursor-pointer"
            >
              {/* الصورة */}
              <div className="relative h-56 overflow-hidden">
                ...
                >
                  <HiOutlineHeart
                    className={`w-4 h-4 transition-colors duration-300 ${liked.includes(property.id)
