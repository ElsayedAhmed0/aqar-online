  ...
  return (
    <>
      <style>{`
        ...
        .sonar-ring-1 { animation: sonar 2s ease-out infinite; }
        .sonar-ring-2 { animation: sonar2 2s ease-out infinite; animation-delay: 0.4s; }
        .sonar-ring-3 { animation: sonar3 2s ease-out infinite; animation-delay: 0.8s; }
        @keyframes btnPulse {
      ...
      {/* ✅ على الموبايل بيتخفى — بيظهر بس من md فوق */}
      <div
        className={`hidden md:block fixed top-28 z-40 transition-all duration-700 ${
          isAr ? "left-6" : "right-6"
        } ${
          visible
